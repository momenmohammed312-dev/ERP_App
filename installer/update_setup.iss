; ════════════════════════════════════════════════════════════════════════════
; Inno Setup Script - POS System Update (v2.2.0 → v2.3.0)
; Brand: DEVELOPED BY MO2 | Contact: 01025545211
; This is an UPDATE installer that adds new features and fixes issues
; ════════════════════════════════════════════════════════════════════════════
...
OutputBaseFilename=POS_Update_v{#MyAppVersion}

    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(
            isOwed ? '(علينا)' : '(لنا)',
            style: TextStyle(fontSize: 11, color: isOwed ? Colors.redAccent : Colors.green),
          ),
        ],
      ),
    );
  ...
  Widget _buildTableHeader() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Color(0xFFC9A84C).withValues(alpha: 0.15)),
      ),
      child: const Row(
        children: [
        ...
        children: [
          ...
          Expanded(
            ...
            child: Text(
              ...
              style: TextStyle(color: Colors.redAccent, fontWeight: tx.credit > 0 ? FontWeight.w600 : FontWeight.normal),
            ),
          ),
          Expanded(
            flex: 2,
            child: Text(
              ...
              style: TextStyle(color: Colors.green, fontWeight: tx.debit > 0 ? FontWeight.w600 : FontWeight.normal),
            ),
          ),
          Expanded(
            flex: 2,
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: (isOwed ? Colors.redAccent : Colors.green).withValues(alpha: 0.15),

    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(flex: 2, child: Text('مدين (+)', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.red))),
          Expanded(flex: 2, child: Text('دائن (-)', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.green))),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(flex: 2, child: Text(tx.debit > 0 ? tx.debit.toStringAsFixed(2) : '-', style: const TextStyle(color: Colors.red))),
          Expanded(flex: 2, child: Text(tx.credit > 0 ? tx.credit.toStringAsFixed(2) : '-', style: const TextStyle(color: Colors.green))),
  ...
  Widget _buildFooter(double finalBalance) {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          const Text('الرصيد النهائي الحالي:', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          Text(

...
class BackupService {
  ...
  Future<void> _restoreTablesData(Map<String, dynamic> tablesData) async {
    ...
    // parents (products/accounts/journal_entries/partners/...) always
    // precede their children (variants/bom/orders/lines/...).
    final tableOrder = [
      'users',
      'categories',
      'customers',
